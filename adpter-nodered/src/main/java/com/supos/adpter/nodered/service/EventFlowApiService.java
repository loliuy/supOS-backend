...
@Slf4j
@Service
@ConditionalOnBean(EventflowAdapterService.class)
public class EventFlowApiService extends AbstractFlowApiService {

    public EventFlowApiService(EventflowAdapterService eventflowAdapterService) {
        super(eventflowAdapterService, FlowType.EVENTFLOW.getFlowName());
    }
    ...
    public ExportNodeFlowDto exportFlow(Collection<Long> fids) {
        ...
        return new ExportNodeFlowDto(flowDtos, null, null, flowNodes, globalNodes);
    }
    ...
    public ExportNodeFlowDto exportAllFlow() {
        List<NodeFlowPO> flowRecodes = nodeFlowMapper.selectAll(FlowType.EVENTFLOW.getFlowName());
